...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -970164943L;
    ...
    public final umc.nnmrm.domain.QMember member;

    public final umc.nnmrm.domain.QMission mission;

    public final EnumPath<umc.nnmrm.domain.enums.MissionStatus> status = createEnum("status", umc.nnmrm.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.nnmrm.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.nnmrm.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
