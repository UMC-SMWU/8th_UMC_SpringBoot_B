...
public enum ErrorStatus implements BaseErrorCode {
    ...
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "COMMON4012", "비밀번호가 일치하지 않습니다."),
    ...
    MEMBER_MISSION_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "MEMBERMISSION4002", "이미 미션에 참여중입니다."),

    // 예시,,,
    ARTICLE_NOT_FOUND(HttpStatus.NOT_FOUND, "ARTICLE4001", "게시글이 없습니다."),

    // 페이지 넘버가 잘못됨
    PAGE_NOT_VALID(HttpStatus.BAD_REQUEST, "PAGE4001", "페이지 번호가 잘못되었습니다."),

    // for test
    TEMP_EXCEPTION(HttpStatus.BAD_REQUEST, "TEMP4001", "테스트용 에러입니다."),

    // 카테고리 관련 에러
    FOOD_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "FOOD_CATEGORY4001", "카테고리가 없습니다.");
